        ...
        {modifyMember && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-lg relative border border-gray-200 dark:border-gray-700">
              ...
              {updateError && (
                <div className="mb-4 text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg px-4 py-2 flex items-center gap-2">
                  <FiAlertCircle /> {updateError}
                </div>
              )}
              {updateSuccess && (
                <div className="mb-4 text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg px-4 py-2 flex items-center gap-2">
              ...
              <form className="space-y-6" onSubmit={e => e.preventDefault()}>
                ...
                <div className="flex gap-4 justify-end pt-4 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <button
                    type="button"
                    className="px-6 py-2 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors disabled:opacity-50 flex items-center gap-2"
